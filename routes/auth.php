...
Route::middleware('guest')->group(function () {
    ...
    Route::get('login', [MagicLoginController::class, 'create'])
        ->name('login');

    Route::post('login', [MagicLoginController::class, 'send'])
    ...
    Route::get('login/magic/{token}', [MagicLoginController::class, 'consume'])
...
Route::get('login/magic/activity/{loginToken}/{action}', [MagicLoginController::class, 'verifyDevice'])
    ->middleware(['signed', 'throttle:12,1'])
    ->name('magic-login.activity');
